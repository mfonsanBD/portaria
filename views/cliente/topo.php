	...
	<header>
		<nav class="navbar">
			...
			<ul class="nav justify-content-center">
				...
				<li class="nav-item <?=($this->titulo == "Provisórios") ? 'ativo' : ''?>">
					<a class="nav-link text-secondary" href="<?= URL_BASE ?>provisorios/">Provisórios</a>
				</li>
				<li class="nav-item <?=($this->titulo == "Visitantes") ? 'ativo' : ''?>">
					<a class="nav-link text-secondary" href="<?= URL_BASE ?>visitantes/">Visitantes</a>
				</li>
